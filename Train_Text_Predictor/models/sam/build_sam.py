...
from .modeling import ImageEncoderViT, MaskDecoder, TextDecoder, PromptEncoder, Sam, TextEncoder ,MaskDecoderHQ, TwoWayTransformer
...
def _build_sam(
    ...
    sam = Sam(
        ...
        text_decoder= TextDecoder(args.model_type),
    ...
    if checkpoint is not None:
        ...
        sam.text_encoder = TextEncoder(args.clip_ckpt)
    return sam
