...
class CHASEDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"image":image, 
               "mask": prev_mask.unsqueeze(0), "gt": gt_mask.unsqueeze(0),"label":label, "p_label" : point_label, "text": text, "pt": pt, 'image_meta_dict':image_meta_dict}
...
class ARCADEDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {"image":image, 
               "mask": prev_mask.unsqueeze(0), "gt": gt_mask.unsqueeze(0), "label":label, "text":text, "p_label" : point_label, "pt": pt,'image_meta_dict':image_meta_dict}
