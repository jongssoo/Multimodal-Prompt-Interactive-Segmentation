...
def vis_image_pred_mask(imgs, gt_masks, pred_masks, prev_masks,save_path, reverse = False, points = None, text = None):
    ...
    if c == 2: # for REFUGE multi mask output
        ...
        if points != None:
            for i in range(b):
                ...
                imgs = add_tag(imgs, 'Input image')
                prompt_list = ['Thinner', 'Thicker', 'Extend', 'Denoise', 'Connect']
                prev_masks = add_tag(prev_masks, 'Prev, Prompt: ' +text[0] )
