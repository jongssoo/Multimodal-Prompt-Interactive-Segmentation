...
def parse_args():    
    ...
    parser.add_argument('-exp_name', default='train_text_predictor', type=str, help='experiment name')
    ...
    parser.add_argument('-vis_val', type=int, default=3, help='validation visualization')
    ...
    parser.add_argument('-max_clicks', type=int, default=20, help='start epoch')
    ...
    parser.add_argument('-num_cls', type=int, default=5, help='cls num')
    ...
    parser.add_argument('-dataset', default='hrf' ,type=str,help='dataset name')
