...
from .modeling import ImageEncoderViT, MaskDecoder, TextDecoder, PromptEncoder, Sam, TextEncoder ,MaskDecoderHQ, TwoWayTransformer, PositionEmbeddingSine, MemoryAttention, MemoryEncoder, MemoryAttentionLayer, RoPEAttention, MaskDownSampler, Fuser ,CXBlock
...
def _build_sam(
    ...
    sam = Sam(
        ...
        text_encoder=TextEncoder(args.clip_ckpt),
        text_decoder= TextDecoder(args.model_type, args.num_cls),
        hq_decoder= MaskDecoderHQ(args.model_type, args.num_cls),
