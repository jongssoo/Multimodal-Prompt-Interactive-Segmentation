...
def parse_args():    
    ...
    parser.add_argument('-encoder', type=str, default='vit_l', help='encoder type')
    parser.add_argument('-seg_net', type=str, default='transunet', help='net type')
    parser.add_argument('-mod', type=str, default='' ,help='mod type:seg,cls,val_ad')
    parser.add_argument('-exp_name', default= 'train_squence_module', type=str, help='experiment name')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=10, help='train visualization')
    parser.add_argument('-vis_val', type=int, default=2, help='validation visualization')
    ...
    parser.add_argument('-sim_gpu', type=int, default=3, help='split sim to this gpu')
    parser.add_argument('-epoch_ini', type=int, default=0, help='start epoch')
    parser.add_argument('-image_size', type=int, default=1024, help='image_size')
    parser.add_argument('-out_size', type=tuple, default=(256,256), help='output_size')
    ...
    parser.add_argument('-max_clicks', type=int, default=20, help='maximum clicks')
    ...
    parser.add_argument('-text_predictor_weights', type=str, default = '', help='the text predictor weights file you want to test')
    ...
    parser.add_argument('-dataset', default='chase' ,type=str,help='dataset name')
    parser.add_argument("--model-type", type=str, default="vit_l", 
                        help="The type of model to load, in ['vit_h', 'vit_l', 'vit_b']")
    parser.add_argument('-sam_ckpt', default='./sam_vit_l_0b3195.pth' , help='sam checkpoint address')
    ...
    type=str,
    default='./config/clip',
    help='The path of clip checkpoint')
    opt = parser.parse_args()
