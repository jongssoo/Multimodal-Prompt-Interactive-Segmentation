...
from .modeling import ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, TextEncoder ,MaskDecoderHQ, TwoWayTransformer
...
def _build_sam(
    ...
    sam = Sam(
        ...
        hq_decoder= MaskDecoderHQ(args.model_type),
    ...
    if checkpoint is not None and args.weights == 0:
        ...
        #new_state_dict = {k: v for k, v in state_dict['state_dict'].items() if k in sam.state_dict() and sam.state_dict()[k].shape == v.shape}
