...
def parse_args():    
    ...
    parser.add_argument('-mod', type=str, default='', help='mod type:seg,cls,val_ad') #sam_adpt
    parser.add_argument('-exp_name', default='train_mask_segmentor', type=str, help='experiment name')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=4, help='train visualization')
    parser.add_argument('-vis_val', type=int, default=1, help='validation visualization')
    parser.add_argument('-reverse', type=bool, default=False, help='adversary reverse')
    parser.add_argument('-pretrain', type=bool, default=False, help='adversar y reverse')
